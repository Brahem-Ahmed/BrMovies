...
class GenreSection extends ConsumerStatefulWidget{
  ...
  const GenreSection({required this.isExpanded,
...
// Center the text
          ...
          body: Padding(
              padding: const EdgeInsets.only(left: 16.0, right:
              16),
              child: Row(
                mainAxisAlignment:
...
// 3
        ...
        onSelected: (selected) {
          setState(
              ...
              widget.genreStates[index] = GenreState(
                  ...
                  isSelected:
                  !widget.genreStates[index].isSelected);
  ...
  List<GenreState> getSelectedGenres() {
    return widget.genreStates.where((e) =>
    e.isSelected).toList();
  }
  int totalSelected() {
