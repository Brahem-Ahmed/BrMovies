...
import 'package:br_movies/ui/widgets/not_ready.dart';
...
import '../../widgets/vert_favorite_list.dart';
import '../genres/sort_picker.dart';
...
class _FavoriteScreenState extends ConsumerState<FavoriteScreen> with SingleTickerProviderStateMixin{
 ...
 @override
  ...
  void sortMovies() { if (currentFavorites.isEmpty) {
    return;
  }
  ...
  valueNotifier.value = currentFavorites;
   ...
   Stream<List<Favorite>> getFavorites() {
      return movieViewModel.favoritesStream();
   }
